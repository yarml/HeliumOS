...
COMMON_INCLUDE := $(KERNEL_DIR)/include
CAPI_INCLUDE   := capi_include
...
ARCH_INCLUDES  := $(CURRENT_ARCH)/$(INCLUDE_DIR) $(CURRENT_ARCH)/$(CONFIG_DIR) $(COMMON_INCLUDE) $(CURRENT_ARCH)/$(CAPI_INCLUDE)
LINK_SCRIPT    := $(CURRENT_ARCH)/$(LINK_SCRIPT_N)
SRCD           := $(KERNEL_CORE)/$(SRC_DIR)
INCLUDES       := $(KERNEL_CORE)/$(INCLUDE_DIR) $(KERNEL_CORE)/$(CONFIG_DIR) $(COMMON_INCLUDE) $(CURRENT_ARCH)/$(CAPI_INCLUDE)
OBJD           := $(BDIR)/obj
KOUT           := $(BDIR)/$(KERNEL)
